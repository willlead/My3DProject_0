...
bool TAseParser::LoadTexture(TTextexMap& TexMap)
{
	int iObjectType = -1;
...
bool TAseParser::GetVertexFromIndexData(TCHAR* strToken, DWORD dwSearchIndex, VOID* pData, INT DataType)
{
	GetData(strToken);
...
bool TAseParser::GetData(TCHAR* pString, VOID* pData, INT DataType, bool bLoop)
{
...
bool TAseParser::GetVertexListFromString(TCHAR* strVertexList, DWORD dwNumVertex, vector<D3DXVECTOR3>& VertexList, TCHAR* strToken)
{
...
bool TAseParser::GetFaceListFromString(TCHAR* strFaceList, DWORD dwNumFace, TVertexList& VertexList, TCHAR* strToken)
{
...
bool TAseParser::GetPositionFaceListFromString(TCHAR* strFaceList, DWORD dwNumFace, TVertexList& VertexList, TCHAR* strToken)
{
	if (dwNumFace > 0 && GetData(strFaceList))
	{
		VertexList.pFaceList.resize(dwNumFace);
...
bool TAseParser::GetNormalListFromString(TCHAR* strFaceList, DWORD dwNumFace, TAseMesh*	pGeomObj, TCHAR* strToken)
{
