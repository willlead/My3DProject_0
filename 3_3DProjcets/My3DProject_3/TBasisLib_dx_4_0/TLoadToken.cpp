...
;
const TCHAR* TLoadToken::GetSearchString(TCHAR* szSearchData, bool bLoop)
{
...
INT TLoadToken::SearchTokenArray(INT NumObjType, TCHAR** pObjectType, DWORD dwNextObjectIndex)
{
	INT iIndex = -1;
