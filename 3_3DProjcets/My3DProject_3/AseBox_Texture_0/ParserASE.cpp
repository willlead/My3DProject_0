...
//
//			// 버텍스 버퍼용 값 저장
//			PCT_VERTEX vertexTemp;
//			vertexTemp.p = D3DXVECTOR3(m_ASE.ObjectList[0].VertexList[m_ASE.ObjectList[0].FaceList[iFace].i[iTriangle]]);
//			vertexTemp.c = D3DXVECTOR4(
//				m_ASE.ObjectList[0].ColVertexList[m_ASE.ObjectList[0].ColVertexList[iFace].x,
//				m_ASE.ObjectList[0].ColVertexList[m_ASE.ObjectList[0].ColVertexList[iFace].y,
//				m_ASE.ObjectList[0].ColVertexList[m_ASE.ObjectList[0].ColVertexList[iFace].z,
//				[1.0f]);
...
#pragma region Convert
	...
	for (iLoop = 0; iLoop < m_ASE.ObjectList[GeomCount].FaceList.size() * 3; iLoop++)
	{
		...
		m_ASE.m_VertexList[iLoop].t =
			m_ASE.ObjectList[GeomCount].TexVertexList[m_ASE.ObjectList[GeomCount].TexFaceList[iLoop/3].i[iLoop % 2]];
	}
