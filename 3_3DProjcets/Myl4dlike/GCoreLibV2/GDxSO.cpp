...
namespace DX
{
	HRESULT GDxSO::CreateStreams(ID3D11Device* pd3dDevice,
	...
	bool GDxSO::BeginRTS(ID3D11DeviceContext*    pImmediateContext)
	{
	...
	void GDxSO::EndRTS(ID3D11DeviceContext*    pImmediateContext)
	{
		UINT offset = 0;
		ID3D11Buffer* pVB[1];
		pVB[0] = NULL;
