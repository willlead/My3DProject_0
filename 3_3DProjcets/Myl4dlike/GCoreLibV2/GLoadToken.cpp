...
;
const TCHAR* GLoadToken::GetSearchString(TCHAR* szSearchData, bool bLoop)
{
...
INT GLoadToken::SearchTokenArray(INT NumObjType, TCHAR** pObjectType, DWORD dwNextObjectIndex)
{
	INT iIndex = -1;
