#include "GNormalMap.h"

DWORD GNormalMap::EncodeVectorAsDWORDColor(D3DXVECTOR3* vVector)
{
...
float3 lightdirtangent = mul(lightdir,tbnmatrix);
*/
void GNormalMap::CreateTangentSpaceVectors(D3DXVECTOR3 *v1,
	D3DXVECTOR3 *v2,
	D3DXVECTOR3 *v3,
	float v1u, float v1v,
	float v2u, float v2v,
...
void GNormalMap::Release()
{
}

GNormalMap::GNormalMap(void)
{
}
