...
void GArcBall::SetTranslationRadius( FLOAT fRadiusTranslation ) 
{ 
	m_fRadiusTranslation = fRadiusTranslation; 
}
void GArcBall::SetWindow( INT nWidth, INT nHeight, FLOAT fRadius )
{ 
	m_nWidth = nWidth; 
	m_nHeight = nHeight; 
	m_fRadius = fRadius; 
...
void GArcBall::SetOffset( INT nX, INT nY ) 
{ 
	m_Offset.x = nX; 
	m_Offset.y = nY; 
}
...
D3DXVECTOR3 GArcBall::ScreenToVector( float fScreenPtX, float fScreenPtY )
{
...
//--------------------------------------------------------------------------------------
D3DXQUATERNION GArcBall::QuatFromBallPoints(const D3DXVECTOR3 &vFrom, const D3DXVECTOR3 &vTo)
{
...
void GArcBall::OnBegin( int nX, int nY )
{
...
void GArcBall::OnMove( int nX, int nY )
{
    if (m_bDrag) 
    { 
...
// Desc:
//--------------------------------------------------------------------------------------
LRESULT GArcBall::HandleMessages( HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam )
{
